...
<head>
<title>Ciphertext Attribute-based Encryption</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style5">File Contents</span>::</h2>
          <div class="clr"></div>
        </div>
        <div class="article">
          <h2>
          ...
          <p align="center"><a href="ViewCloudFiles.jsp">Back</a></p>
        </div>
      </div>
	            <%
	   }
...
%>
      <div class="sidebar">
        ...
        <div class="clr"></div>
        <div class="gadget">
          <h2 class="star">Cloud ServerMenu</h2>
          <div class="clr"></div>
          <ul class="sb_menu">
