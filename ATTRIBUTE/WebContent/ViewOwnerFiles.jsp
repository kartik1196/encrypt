          ...
          <div class="article">
		    ...
		    <table width="653" border="1" align="left">
              <tr>
                ...
                <td width="161"><div align="center"><span class="style5">View</span></div></td>
                <td width="161"><div align="center"><span class="style5">Access</span></div></td>
              </tr>
              <%
	...
	while ( rs.next() )
	   {
		...
		%>
              <tr>
                ...
                <td><a href="viewfile.jsp?id=<%=i%>&fname=<%=s2%>&oname=<%=s3 %>" >Authority</a></td>
              </tr>
              <%
	   }
